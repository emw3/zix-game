...
export const TUTORIAL_MISSIONS = [
  {
    ...
    blocks: [
      { id: "right", icon: "➡️", es: "Derecha", en: "Right", color: "#45B7D1", type: "direction" },
      { id: "down", icon: "⬇️", es: "Abajo", en: "Down", color: "#4ECDC4", type: "direction" },
      { id: "left", icon: "⬅️", es: "Izquierda", en: "Left", color: "#7C6FE0", type: "direction" },
      { id: "up", icon: "⬆️", es: "Arriba", en: "Up", color: "#E07C6F", type: "direction" },
      { id: "pick", icon: "⭐", es: "Recoger", en: "Pick up", color: "#FFB347", type: "action" },
    ],
    grid: { cols: 5, rows: 4 },
    startPos: { x: 0, y: 0 },
    items: [
  ...
  },
  {
    ...
    blocks: [
      { id: "right", icon: "➡️", es: "Derecha", en: "Right", color: "#45B7D1", type: "direction" },
      { id: "down", icon: "⬇️", es: "Abajo", en: "Down", color: "#4ECDC4", type: "direction" },
      { id: "if_water", icon: "🌊", es: "SI agua → nadar", en: "IF water → swim", color: "#FF6B8A", type: "conditional" },
      { id: "if_rock", icon: "🪨", es: "SI roca → saltar", en: "IF rock → jump", color: "#FFB347", type: "conditional" },
      { id: "pick", icon: "🚀", es: "Recoger nave", en: "Pick up ship", color: "#FFD700", type: "action" },
    ],
    grid: { cols: 5, rows: 4 },
    startPos: { x: 0, y: 1 },
    items: [{ x: 4, y: 1, emoji: "🚀" }],
  ...
  },
  {
    ...
    maxBlocks: 5,
    hint: {
      es: "¡El camino es largo pero solo tienes 5 bloques! Toca Repetir ×3, luego toca Derecha para ponerla dentro!",
      en: "The path is long but you only have 5 blocks! Tap Repeat ×3, then tap Right to put it inside!",
    },
    blocks: [
      { id: "right", icon: "➡️", es: "Derecha", en: "Right", color: "#45B7D1", type: "direction" },
      { id: "pick", icon: "⭐", es: "Recoger", en: "Pick up", color: "#FFB347", type: "action" },
      { id: "repeat3", icon: "🔄×3", es: "Repetir ×3", en: "Repeat ×3", color: "#8E44AD", type: "loop", repeatCount: 3, maxChildren: 1 },
    ],
    grid: { cols: 7, rows: 1 },
    startPos: { x: 0, y: 0 },
    items: [{ x: 6, y: 0, emoji: "🚀" }],
